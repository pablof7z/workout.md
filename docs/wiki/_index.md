...
|--------|------|---------|-------|
| [2026-07-10-42f3cd42f2de-75af564c-1-final-product-readiness-gate-re-audit](research/2026-07-10-42f3cd42f2de-75af564c-1-final-product-readiness-gate-re-audit.md) | 2026-07-10 | Final product-readiness gate: re-audit of feature-complete app against pre-registered punch-list (B1-B4, M1-M5, M7) with build verification and live coach tool-mutation test; verdict PASS | a63dd1919dc0e4d76 |
...
| [2026-07-10-42f3cd42f2de-75af564c-1-real-persisted-plan-model-replaces-hardcoded](episodes/2026-07-10-42f3cd42f2de-75af564c-1-real-persisted-plan-model-replaces-hardcoded.md) | 2026-07-10 | Real persisted plan model replaces hardcoded MockWorkout demo | reversal | superseded |
| [2026-07-10-42f3cd42f2de-75af564c-1-set-input-redesign-floating-lines-reps](episodes/2026-07-10-42f3cd42f2de-75af564c-1-set-input-redesign-floating-lines-reps.md) | 2026-07-10 | Set-input redesign: floating-lines reps+weight in main content | product | active |
...
| [2026-07-10-42f3cd42f2de-75af564c-2-reasoning-model-think-tag-stripping-in](episodes/2026-07-10-42f3cd42f2de-75af564c-2-reasoning-model-think-tag-stripping-in.md) | 2026-07-10 | Reasoning-model think-tag stripping in coach streaming | root-cause | active |
| [2026-07-10-42f3cd42f2de-75af564c-3-nip-29-join-request-kind-9021](episodes/2026-07-10-42f3cd42f2de-75af564c-3-nip-29-join-request-kind-9021.md) | 2026-07-10 | NIP-29 join-request (kind 9021) for channel access | product | active |
| [2026-07-10-42f3cd42f2de-75af564c-3-reasoning-model-think-tag-leak-root](episodes/2026-07-10-42f3cd42f2de-75af564c-3-reasoning-model-think-tag-leak-root.md) | 2026-07-10 | Reasoning-model think-tag leak: root cause and streaming-safe ThinkStripper | root-cause | superseded |
| [2026-07-10-42f3cd42f2de-75af564c-4-github-oauth-device-flow-replaces-pat](episodes/2026-07-10-42f3cd42f2de-75af564c-4-github-oauth-device-flow-replaces-pat.md) | 2026-07-10 | GitHub OAuth device flow replaces PAT as primary auth | reversal | active |
...
| [2026-07-10-42f3cd42f2de-75af564c-5-mockworkout-replaced-by-real-planrecord-as](episodes/2026-07-10-42f3cd42f2de-75af564c-5-mockworkout-replaced-by-real-planrecord-as.md) | 2026-07-10 | MockWorkout replaced by real PlanRecord as Today source-of-truth | reversal | active |
...
|------|------|--------|------------|
| [blockkind](nouns/blockkind.md) | BlockKind | extracted | An enum distinguishing straight-sets vs. superset/circuit groups in the domain model, used by WorkoutBlock to represent how exercises are grouped in a session. |
...
| [deviations](nouns/deviations.md) | Deviations | extracted | Missed reps, skips, subs, pain, fatigue, and missed sessions — treated as first-class data that feeds planning, not errors. Deviation is the happy path: the plan is disposable and reality is the source of truth. |
...
| [markdown-as-substrate](nouns/markdown-as-substrate.md) | Markdown (as substrate) | extracted | The substrate and storage/portability layer of the app — under the hood every workout is a clean .md file you could open in Obsidian — but never the interface; you never type it. |
