...
/// a selection haptic at each detent and a light impact on commit. Releasing records the value into
/// the shared `WorkoutSession`; tapping the committed state re-opens it to adjust.
